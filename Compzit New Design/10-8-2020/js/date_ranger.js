var app = angular.module('datePickerApp', ['daterangepicker']);

angular.module('datePickerApp')
  .controller('DateRangePickerExample', function ($scope) {
    $scope.test = 'bla';
    $scope.options = {
         "opens": "left",
         "showDropdowns": true,
      locale: { applyLabel: 'Save' },  
              ranges: {
           'Today': [moment(), moment()],
          ...
          'Last Month': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
           ...
           'Last Quarter': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
